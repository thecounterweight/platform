...
- Transparent (every participant sees the breakdown)
- Significantly less than traditional distributor margins (which can be 20-40%)
...
- Retail shopkeepers
- Restaurant owners sourcing ingredients
- Craftspeople buying raw materials
- Online sellers sourcing products
- Anyone buying in quantity who benefits from bulk pricing
